...
from .Const import detailsMessages, LETTERS, DIGITS, TT_LPAREN, TT_RPAREN, TT_LSQUARE, TT_RSQUARE, TT_COMMA, TT_ARROW, TT_EOF, TT_INT, TT_FLOAT, TT_PLUS, TT_MINUS, TT_MOD, TT_MUL, TT_DIV, TT_POW, TT_EE, TT_EQ, TT_KEYWORD, KEYWORDS, TT_IDENTIFIER, TT_STRING, TT_NE, TT_LT, TT_LTE, TT_GT, TT_GTE, TT_MM, TT_NEWLINE
